...
def sca(objective_function, lb, ub, dim, num_agents, max_iter, seed=None):
    ...
    for t in range(max_iter):
        ...
        # for 2D slides (first 20 iterations)
...
def plot_mean_std(mean_curve, std_curve, title="Average Minimum Value with Std", fname="f1_mean_std.png"):
...
if __name__ == "__main__":
    ...
    plot_mean_std(mean_curve, std_curve, title="Sphere f1: Average Min ± Std")

    # 2) Visualization demo (D=2)
    demo_plots_for_D2()

    print("\\nOutput files:")
    print(" - f1_contour.png")
    print(" - slides_f1/f1_agents_iter_01.png ... f1_agents_iter_20.png")
    print(" - f1_convergence.png")
    print(" - f1_mean_std.png")
